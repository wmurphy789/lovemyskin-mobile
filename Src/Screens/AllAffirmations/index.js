              ...
              renderItem={({ item, index }) => {
                return (
                  <TouchableOpacity
                    activeOpacity={0.9}
                    onPress={() => {
                      viewAffirmation(item.tileName, item.tileColor);
                    }}
                  >
                    <View
                      style={[
